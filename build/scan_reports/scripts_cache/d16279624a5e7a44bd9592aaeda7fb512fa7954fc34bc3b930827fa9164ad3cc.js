...
.nav-item{padding:10px 20px;cursor:pointer;font-size:.9rem;color:var(--text-sub);display:flex;align-items:center;transition:.2s;border-left:3px solid transparent}
...
.banner{height:220px;background-image:url('by.jpg');display:flex;flex-direction:column;justify-content:center;align-items:center;padding:20px;color:#fff;background-size:cover;background-position:center;background-repeat:no-repeat;transition:height .3s}
...
.notice-list{list-style:none;position:absolute;top:0;left:0;width:100%;animation:scrollUp 12s infinite cubic-bezier(.68,-.55,.27,1.55)}
...
.section-header{font-size:1.05rem;color:var(--text-sub);margin:30px 0 15px 0;display:flex;align-items:center;font-weight:600;opacity:.9}
.section-header::before{content:"#";margin-right:6px;font-weight:400;font-size:1.1rem;color:#cbd5e1}
...
.card{background:var(--bg-card);border-radius:8px;padding:14px;display:flex;align-items:center;text-decoration:none;color:inherit;transition:all .2s;position:relative;overflow:hidden;border:1px solid transparent;box-shadow:0 1px 2px rgba(0,0,0,.03);cursor:pointer;content-visibility:auto;contain-intrinsic-size:60px}
@media (hover:hover){.card:hover{transform:translateY(-2px);box-shadow:0 8px 16px rgba(0,0,0,.06);border-color:rgba(59,130,246,.3)}
}
.card-img{width:36px;height:36px;border-radius:6px;background:var(--bg-body);margin-right:12px;object-fit:cover;flex-shrink:0}
.card-info{flex:1;overflow:hidden;padding-right:20px;display:flex;flex-direction:column;justify-content:center;gap:2px}
...
.card-views{position:absolute;top:6px;right:8px;font-size:10px;color:#f59e0b;background:rgba(245,158,11,.1);padding:1px 4px;border-radius:4px;display:flex;align-items:center;gap:2px}
...
.timeline-item::before{content:'';position:absolute;left:-27px;top:5px;width:10px;height:10px;border-radius:50%;background:var(--bg-card);border:2px solid var(--primary);z-index:1}
.timeline-date{font-size:.75rem;color:var(--primary);font-weight:600;margin-bottom:4px;display:inline-block;background:rgba(59,130,246,.1);padding:1px 6px;border-radius:4px}
.timeline-content{font-size:.9rem;color:var(--text-main);line-height:1.5}
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-footer" id="prodFooter" style="display: none;">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center;">
                <span class="app-version">v2.5</span>
                <span>&copy; 2026</span>
            </div>
        </div>
    ...
    <main class="main-viewport" id="mainViewport">
        ...
        <footer class="footer">
            <p>版权所有 &copy; 2026 <span class="clickable" onclick="window.open('https://t.me/ddgksf2013', '_blank')">ddgksf2013</span> All rights reserved.</p>
    ...
    <script>
        ...
        const BANNER_IMG = 'https://ddgksf2013.top/by.jpg';
        ...
        const CHANGE_LOGS = [
			{ date: '2026-04-04', content: '增加AppStore地区切换' },
			{ date: '2026-03-21', content: '增加图片压缩网站索引' },
			{ date: '2026-01-10', content: '增加看理想索引' },
        ...
        const NOTICES = [
            { text: "欢迎访问墨鱼手记，更新日期2026-04-09..", url: "https://ddgksf2013.top" },
        ...
        const initialData = [
			{
                "category": "プロモーション",
                "items": [
					//{ "name": "东东年货红包", "url": "https://u.jd.com/JOMkqlg", "desc": "今日可领", "icon": "https://files.catbox.moe/ul67fi.png" },
            ...
            },
            {
                "category": "资源推荐",
                "items": [
					{ "name": "Cuttlefishの自留地", "url": "https://t.me/ddgksf2021", "desc": "资讯发布第一地", "icon": "https://t.me/i/userpic/160/ddgksf2021.jpg" },
